    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (resultCode== Activity.RESULT_OK && requestCode==REQUEST_CODE_AUTOCOMPLETE){
            ...
            Toast.makeText(MapActivity.this,
                    String.format(getString(R.string.selected_place_info),
            ...
            if (mapboxMap !=null){
                ...
                if (style!=null){
                    ...
                    destinationMarker= mapboxMap.addMarker(new MarkerOptions().position(new LatLng(((Point) selectedCarmenFeature.geometry()).latitude(),((Point) selectedCarmenFeature.geometry()).longitude())));
